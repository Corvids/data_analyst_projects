...
print (box_plot1); print (box_plot2)
...
# scatterplot matrix for quality, pH, 

ggpairs(df_corr, alpha=0.4) +
...
### Correlation matrix for all variables with labeled correlation values
