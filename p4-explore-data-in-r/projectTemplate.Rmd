...
Without looking further at the data set, I think that pH, chlorides, alcohol, and residual.sugar may be important.
...
mcor <- cor(df_corr)
round(mcor, digits=2) # not very nice to look at
...
# bar graphs
ggplot(data, aes(x=quality, y=pH, fill=type)) + geom_bar(stat="identity")
ggplot(data, aes(x=pH, y=alcohol, fill=type)) + geom_bar(stat="identity")
ggplot(data, aes(x=pH, y=quality, fill=type)) + geom_bar(stat="identity")
