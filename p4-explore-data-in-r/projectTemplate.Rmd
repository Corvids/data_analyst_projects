...
We will begin the analysis by looking at the distribution of each of the above variables individually to see if they're skewed, contain outliers, etc.
...
plotmatrix(df_corr, colour="gray20") +
